...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-5/12 bg-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <h2 class="text-4xl font-bold text-white leading-tight mb-4">
                Créez un nouveau<br>
                <span class="text-orange-400">mot de passe</span>
            </h2>
    ...
    <div class="w-full lg:w-7/12 flex items-center justify-center bg-gray-50 px-6 py-12">
        <div class="w-full max-w-md">
            ...
            {{-- Titre --}}
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-slate-900 mb-1">Nouveau mot de passe</h1>
                <p class="text-slate-500">Entrez votre nouveau mot de passe ci-dessous.</p>
            </div>
