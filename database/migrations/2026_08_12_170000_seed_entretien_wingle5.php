...
/**
 * Wingle 5 (GWM) : l'utilisateur a confirmé que ce modèle partage exactement
 * le même barème d'entretien que le Wingle 7 (même document constructeur
 * fourni pour les deux) — voir 2026_08_12_160000_seed_entretien_wingle7.php
 * pour le détail des choix de transcription (permutation des pneus en
 * 'inspecter', courroies/huile de boîte de transfert en 'remplacer').
 */
return new class extends Migration
{
    public function up(): void
    {
        $id = DB::table('types_moteur')->insertGetId([
            'code' => 'WINGLE5', 'marque' => 'GWM', 'modele' => 'Wingle 5',
            'libelle' => 'Wingle 5', 'created_at' => now(), 'updated_at' => now(),
        ]);
